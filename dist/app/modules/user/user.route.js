...
router.get("/all-users", (0, check_auth_1.checkAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.SUPER_ADMIN, user_interface_1.Role.SENDER), user_controller_1.UserController.getAllUsers);
router.get("/me", (0, check_auth_1.checkAuth)(...Object.values(user_interface_1.Role)), user_controller_1.UserController.getMe);
router.patch("/me", (0, check_auth_1.checkAuth)(...Object.values(user_interface_1.Role)), (0, validateRequest_1.validateRequest)(user_validation_1.updateUserZodSchema), user_controller_1.UserController.updateMyProfile);
